...
const VirtualRoom = () => {
  ...
  const NotificationComponent = ({ message, type, onClose }: any) => (
    <View style={[
      styles.notification,
      type === 'error' ? styles.errorNotification : styles.successNotification
    ]}>
  ...
  const renderGame = () => (
    <View style={styles.container}>
      <View style={styles.headerRow}>
        <Text style={styles.regularText}>Question {gameState.questionNumber}/{gameState.totalQuestions}</Text>
        ...
        <View style={styles.optionsContainer}>
          {gameState.currentQuestion?.options.map((option, index) => (
            ...
            >
              <Text style={[
                styles.optionText,
                userInput.selectedAnswer === option && styles.selectedOptionText
              ]}>
                {option}
              </Text>
            </TouchableOpacity>
